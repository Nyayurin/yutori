...
class AdapterListenersContainerBuilder {
	...
	fun build() = AdapterListenersContainer(
		any = any.toList(),
		guild = guild.build(),
	...
	class Guild {
		...
		fun build() = AdapterListenersContainer.Guild(
			added = added.toList(),
		...
		class Member {
			...
			fun build() = AdapterListenersContainer.Guild.Member(
				added = added.toList(),
				updated = updated.toList(),
				removed = removed.toList(),
				request = request.toList(),
		...
		class Role {
			...
			fun build() = AdapterListenersContainer.Guild.Role(
	...
	class Interaction {
		...
		fun build() = AdapterListenersContainer.Interaction(
	...
	class Login {
		...
		fun build() = AdapterListenersContainer.Login(
			added = added.toList(),
			removed = removed.toList(),
			updated = updated.toList(),
		)
	...
	class Message {
		...
		fun build() = AdapterListenersContainer.Message(
			created = created.toList(),
			updated = updated.toList(),
			deleted = deleted.toList(),
		)
	...
	class Reaction {
		...
		fun build() = AdapterListenersContainer.Reaction(
			added = added.toList(),
			removed = removed.toList(),
		)
	}
	...
	class Friend {
		...
		fun build() = AdapterListenersContainer.Friend(
			request = request.toList(),
		)
	}
}