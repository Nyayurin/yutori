...
abstract class Action(
    ...
    protected suspend inline fun <reified T> send(method: String, vararg content: Pair<String, Any?>): T =
...
class RootActions(platform: String, self_id: String, service: ActionService, satori: Satori) : Actions() {
    ...
    class ChannelAction(platform: String, self_id: String, service: ActionService) : Action(
        ...
        suspend fun get(channel_id: String, vararg contents: Pair<String, Any> = arrayOf()): Channel =
        ...
        suspend fun create(guild_id: String, data: Channel, vararg contents: Pair<String, Any> = arrayOf()): Channel =
            send("create", "guild_id" to guild_id, "data" to data, *contents)

        suspend fun update(channel_id: String, data: Channel, vararg contents: Pair<String, Any> = arrayOf()): Unit =
            send("update", "channel_id" to channel_id, "data" to data, *contents)

        suspend fun delete(channel_id: String, vararg contents: Pair<String, Any> = arrayOf()): Unit =
            send("delete", "channel_id" to channel_id, *contents)

        suspend fun mute(channel_id: String, duration: Number, vararg contents: Pair<String, Any> = arrayOf()): Unit =
    ...
    class GuildAction(platform: String, self_id: String, service: ActionService) : Action(
        ...
        suspend fun get(guild_id: String, vararg contents: Pair<String, Any> = arrayOf()): Guild =
            send("get", "guild_id" to guild_id, *contents)

        suspend fun list(next: String? = null, vararg contents: Pair<String, Any> = arrayOf()): PagingList<Guild> =
        ...
        class MemberAction(platform: String, self_id: String, service: ActionService) : Action(
            ...
            suspend fun get(guild_id: String, user_id: String, vararg contents: Pair<String, Any> = arrayOf()): GuildMember =
        ...
        class RoleAction(platform: String, self_id: String, service: ActionService) : Action(
            ...
            suspend fun create(guild_id: String, role: GuildRole, vararg contents: Pair<String, Any> = arrayOf()): GuildRole =
            ...
            suspend fun delete(guild_id: String, role_id: String, vararg contents: Pair<String, Any> = arrayOf()): Unit =
    ...
    class LoginAction(platform: String, self_id: String, service: ActionService) : Action(
        ...
        suspend fun get(vararg contents: Pair<String, Any> = arrayOf()): Login = send("get", *contents)
    }
    ...
    class MessageAction(private val satori: Satori, platform: String, self_id: String, service: ActionService) : Action(
        ...
        suspend fun create(channel_id: String, content: String, vararg contents: Pair<String, Any> = arrayOf()): List<Message> =
            send(
        ...
        suspend fun get(channel_id: String, message_id: String, vararg contents: Pair<String, Any> = arrayOf()): Message =
            send("get", "channel_id" to channel_id, "message_id" to message_id, *contents)

        suspend fun delete(channel_id: String, message_id: String, vararg contents: Pair<String, Any> = arrayOf()): Unit =
    ...
    class UserAction(platform: String, self_id: String, service: ActionService) : Action(
        ...
        suspend fun get(user_id: String, vararg contents: Pair<String, Any> = arrayOf()): User =
    ...
    class FriendAction(platform: String, self_id: String, service: ActionService) : Action(
        ...
        suspend fun list(next: String? = null, vararg contents: Pair<String, Any> = arrayOf()): PagingList<User> =
            send("list", "next" to next, *contents)
    ...
    class UploadAction(platform: String, self_id: String, service: ActionService) : Action(
        ...
        suspend fun create(vararg contents: FormData): Map<String, String> = upload("create", contents.toList())
    }
    ...
    class AdminAction(service: ActionService) {
        ...
        class LoginAction(service: ActionService) : Action(null, null, "login", service) {
            suspend fun list(vararg contents: Pair<String, Any> = arrayOf()): List<Login> = send("list", *contents)
        }

        class WebhookAction(service: ActionService) : Action(null, null, "webhook", service) {
            suspend fun create(url: String, token: String? = null, vararg contents: Pair<String, Any> = arrayOf()): Unit =
                send("list", "url" to url, "token" to token, *contents)

            suspend fun delete(url: String, vararg contents: Pair<String, Any> = arrayOf()): Unit =
